...
VStack {
                            ...
                            ZStack{
                                ...
                                TextField("Enter your feedback", text: $feedbackarea)
                                    ...
                                    .padding()
                                    .foregroundColor(.white)
                                    .background(LinearGradient(gradient: Gradient(colors: [Color("GraidantColorwhite"), Color("GraidantColorwhite")]), startPoint: .leading, endPoint: .trailing))
                                    .cornerRadius(20)
                            }
                ...
                ZStack{
                    ...
                    VStack{
                        Image(systemName: "hand.thumbsup")
                            ...
                            .padding()
                            .foregroundColor(Color("GraidantColorwhite"))
                        ...
                        Button(action: {
                            ...
                            NavigationLink(destination: HomePage(), isActive: $navigateToView) {
                                EmptyView()
                            }
                        }
                        .navigationTitle("")
